...
LOTTERY_DATA_LIMITS = {
    '4x20': {
        'max_draws_in_db': 500,        # 4x20 проводится 7 раз в день = ~2555 в год
        'initial_fetch': 400,          # При первой загрузке
        'update_fetch': 50,            # При обновлениях
        'min_for_training': 200        # Минимум для качественного обучения
    },
    '5x36plus': {
        'max_draws_in_db': 1000,       # Каждые 15 мин = ~35000 в год, берем последние 1000
        'initial_fetch': 800,          # При первой загрузке
